...
import { Form, Input, Button, Card, Typography, Col, Row, notification, Spin, Space } from 'antd';
          ...
          <Space size="middle">
            ...
            >
              <Route path='/privacy-policy' component={() => {
                window.location.href = 'https://teacher.wiiquiz.com/';
                return null;
              }} />
              <a href="https://teacher.wiiquiz.com/">Giáo viên</a>
            </Button>
          </Space>
        </div>
