...
import { Form, Input, Button, Card, Radio, DatePicker, Select } from "antd";
  ...
  return (
    <AddStudentWrapper>
      <Spin tip="Đang thêm học viên..." spinning={addLoading}>
        ...
        >
          {/* <Title level={3} style={{ paddingTop: "25px", paddingBottom: "10px" }}>
            <UserAddOutlined style={{ marginRight: '10px' }} />Thêm học sinh mới
          </Title> */}
          {/* <hr style={{height: '1px', border: 'none', backgroundColor: '#E5E5E6', marginTop: '5px', marginBottom: '10px'}}/> */}
          {/* <br/> */}
